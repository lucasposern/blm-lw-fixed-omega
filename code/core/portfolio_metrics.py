...
HIGH-LEVEL: Wiederverwendbare Performance-Metriken für Portfolio-Backtests.

Erscheint in: run_backtest_ff25.py (und zukünftigen Backtest-Skripten,
              z.B. run_backtest_sp500.py, Sensitivitätsanalysen in Kapitel 5)
